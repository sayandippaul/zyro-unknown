        ...
        <section className="section relative overflow-hidden bg-black min-h-screen py-20">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 pointer-events-none z-10 hidden lg:block">
                <svg width="100" height="600" viewBox="0 0 100 600" className="opacity-80">
                    <path d="M50 0 L50 200 L80 230 L80 370 L50 400 L50 600" stroke="#00E08F" strokeWidth="2" fill="none" />
                    <rect x="46" y="0" width="8" height="8" fill="#00E08F" filter="url(#glow-bm)" />
                    <rect x="46" y="592" width="8" height="8" fill="#00E08F" filter="url(#glow-bm)" transform="rotate(45 50 596)" />
                    <defs>
                        <filter id="glow-bm">
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none z-10 hidden lg:block">
                <svg width="100" height="600" viewBox="0 0 100 600" className="opacity-80 scale-x-[-1]">
                    <path d="M50 0 L50 200 L80 230 L80 370 L50 400 L50 600" stroke="#00E08F" strokeWidth="2" fill="none" />
                    <rect x="46" y="0" width="8" height="8" fill="#00E08F" filter="url(#glow-bm2)" />
                    <rect x="46" y="592" width="8" height="8" fill="#00E08F" filter="url(#glow-bm2)" transform="rotate(45 50 596)" />
                    <defs>
                        <filter id="glow-bm2">
                            <feGaussianBlur stdDeviation="3" result="coloredBlur" />
                            <feMerge>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <h3 className="text-xl font-bold text-white mb-2 relative z-10">{component.title}</h3>
                                        <p className="text-gray-400 text-sm leading-relaxed relative z-10">{component.description}</p>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <h3 className="text-xl font-bold text-white mb-2 relative z-10">{component.title}</h3>
                                        <p className="text-gray-400 text-xs leading-relaxed relative z-10">{component.description}</p>
                                    </div>
                                </div>
